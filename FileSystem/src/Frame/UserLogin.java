...
public class UserLogin<Textfield> extends JFrame {
	...
	public UserLogin() {
		...
		//定义【输入密码】的【文本框】
		final JPasswordField inputUserPassword_Field = new JPasswordField();  
		...
		inputUserPassword_Field.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				//【回车】按键判断
				if(e.getKeyChar() == KeyEvent.VK_ENTER )  {
					System.out.println(inputUserPassword_Field.getText().length());
					try {
	...
	public void successLogin(int namelength,int passwordlength,String userName,String userPassword) throws SQLException {
