...
private static JFrame Jframe;
   ...
   private void processConnection() throws IOException{
      do { 
         ...
         if(message.equals("LOGIN_TRUE")) {
        	 ...
        	 UserFrame userFrame=new UserFrame(user_role,user_name);
		     userFrame.showMenu(user_role,user_name);
			 Jframe.dispose();	 
         }
 ...
 public  static void Login(String name,String password,JFrame userLogin) throws IOException {
  ...
  public static void ChangeSelfInfo(String old_password,String new_password,String new_password2) throws IOException {
   ...
   public static void Display_user() throws IOException {
	   output.writeUTF("displayUser");
	   output.flush();
   }
   public static void Display_Doc() throws IOException {
	   output.writeUTF("displayDoc");
	   output.flush();
   }
   public static void DelUser(String del_name,JFrame frame) throws IOException {
  ...
  public static void UpdateUser(String name,String password,String role,JFrame frame) throws IOException {
   ...
   public static void AddUser(String name, String password,String role,JFrame userLogin) throws IOException {
	   Jframe=userLogin;
   ...
   public static void Download(String ID,JFrame frame) throws IOException {
	   Jframe=frame;
   ...
   public static void Upload(String ID,String Creator,String description,String filename,JFrame userLogin) throws IOException{
	   Jframe=userLogin;
